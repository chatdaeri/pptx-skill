...
| 용도 | 원본 px | PPTX pt | 비고 |
|------|--------|---------|------|
| 메인 타이틀 | 36~40px | 15~18pt | 슬라이드 핵심 메시지 |
| 서브 타이틀 | 22~26px | 9~11pt | 메인 위 보조 설명 |
| 섹션 레이블 | 13~14px | 6~7pt | 좌상단 위치 표시 |
| 소제목 | 16~18px | 7~8pt | ◎ 마커 포함 |
| 본문/테이블 | 13~14px | 6~7pt | 일반 텍스트 |
| 출처/주석 | 11~12px | 5~5.5pt | 우측 상단 출처 |
| 페이지 번호 | 11px | 5pt | 우측 하단 |
...
CSS에서는 `#` 접두사를 사용하고, PptxGenJS에서는 `#`을 제거해야 한다.

| 용도 | CSS (HTML용) | PptxGenJS용 |
|------|-------------|------------|
| 강조 블루 | `#2196F3` | `2196F3` |
| 강조 옐로우 | `#FFD600` | `FFD600` |
| 흰색 텍스트 | `#ffffff` | `FFFFFF` |
| 보조 텍스트 | `#cccccc` | `CCCCCC` |
